        ...
        }else
        {
            ...
            }else
            {
                ...
                if(v4l2_config[i].data_idx == OFRC_MODE) {
                    ...
                    /*
                    //1. color + circle
                    IplImage *src_img = cvCreateImageHeader(cvSize(VIDEO_WIDTH, VIDEO_HEIGHT), IPL_DEPTH_8U, 3);
                    src_img->imageData = (char *)v4l2_config[i].video_buf.buffers[video_buf.index].start;

                    cvCircle(
                        src_img,
                        cvPoint(VIDEO_WIDTH / 2, VIDEO_HEIGHT / 2),
                        100,
                        cvScalar(0, 0, 255, 0),
                        //CV_RGB(255, 0, 0),
                        2,
                    ...
                    */
                    ...
                    if (gray_img == NULL) {
                        gray_img = cvCreateImage(cvSize(VIDEO_WIDTH, VIDEO_HEIGHT), IPL_DEPTH_8U, 1);
                    }
                    ...
                    glTexImage2D(GL_TEXTURE_2D, 0, GL_LUMINANCE, VIDEO_WIDTH, VIDEO_HEIGHT, 0, GL_LUMINANCE, GL_UNSIGNED_BYTE, gray_img->imageData);
